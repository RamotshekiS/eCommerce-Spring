...
import com.selloramotsheki.eCommerce.service.category.ICategoryService;
...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse> updateCategory(@PathVariable Category category, Long id) {
        try {
